 ...
 * Note that this class is not thread safe. Calls to server lifecycle methods
 * in this class must be externally synchronized if made by multiple threads.
 *
...
public class ZooKeeperTestServer {
  ...
  private volatile boolean shutdownRegistered = false;
  ...
  public final int startNetwork() throws IOException, InterruptedException {
    ...
    connectionFactory.configure(new InetSocketAddress(port), -1);
